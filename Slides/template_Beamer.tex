...
\begin{document}
	...
	\end{frame}
	\section{Outline}
	\note{Überblick, nicht ins mathematische Detail}
	...
	\begin{frame}{Cross-entropy}
		\begin{itemize}
			...
			\end{equation}
		\end{itemize}
		\note{Label: one-hot\\i-te Klasse\\Maximum Likelihood Estimation}
	\end{frame}
	\begin{frame}{Stochastic Gradient Descent}
		...
		\end{itemize}
		\note{$\Rightarrow$ Kleine Änderungen in die entgegengesetze Richtung des Gradienten\\Learning Rate nicht zu klein und nicht zu groß\\Erweiterungen}
	\end{frame}
	\begin{frame}{Stochastic Gradient Descent}
		\begin{figure}
			\begin{center}
